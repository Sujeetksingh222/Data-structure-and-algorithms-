//problem:- Given a doubly linked list,we need to delete element from the brginning of the doubly linkedd list
...
int main()
{
    ...
    print_Node(head);
    delete_Node(head);
    cout<<"Elements of the doubly linked list after deletion of the first element:";
    print_Node(head);
    return 0;
}